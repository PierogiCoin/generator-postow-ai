...
import { ContentInventoryPreview } from '@/components/strategist/ContentInventoryPreview';
import {
...
const ReportDisplay: React.FC<{
    ...
    const handleGenerateClick = async (item: IntelligentCalendarPlanItem) => {
        ...
        navigateToCalendarSlot(item, (url) => router.push(url), true);
    };
    ...
    }, [report.actionablePlan, router, intelligentCalendarPlan, setIntelligentCalendarPlan]);
    ...
    return (
        <div className="page-shell">
            ...
            {report.competitiveSnapshot?.length > 0 && (
                <div id="report-competitors" className="scroll-mt-24 p-6 bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl content-auto">
            ...
            {report.contentAdaptation && (
                <div className="p-6 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl">
                    ...
                    <div className="grid-auto-fit-sm text-sm">
            ...
            {report.intelligenceInsights && (
                <div className="p-6 bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 rounded-xl">
                    ...
                    <div className="grid-auto-fit-lg text-sm">
            ...
            {/* SWOT */}
            {report.swot && (
            <div id="report-swot" className="scroll-mt-24 p-6 bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl content-auto">
            ...
            {/* Plan */}
            <div id="report-plan" className="scroll-mt-24 p-6 bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl content-auto">
...
export const AIStrategistView: React.FC = () => {
    ...
    const isStrategistEnabled = [UserPlan.Pro, UserPlan.Agency, UserPlan.Business, UserPlan.Enterprise, UserPlan.Lifetime].includes(userPlan);
    ...
    return (
        <div className="page-shell-narrow">
            ...
            {auditHistory.length > 0 && (
                <div className="p-6 bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl content-auto-sm">
...
export default AIStrategistView;