...
import { BatchCompetitorSummary, type BatchCompetitorResult } from '@/components/intelligence/BatchCompetitorSummary';
      ...
      {competitors.length === 0 ? (
        ...
        <div className="space-y-4 content-auto">
          {competitors.map(comp => (
            <div key={comp.id} className="content-auto-card">
              <CompetitorCard
                competitor={comp}
...
export default CompetitorTrackerPanel;