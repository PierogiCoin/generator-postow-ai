...
// Audio Context for playing TTS narration (initialize on client only)
    ...
    return (
        ...
        >
            <ModernCard hover glass padding="lg" className="relative overflow-hidden group">
                ...
                <div className="page-work-grid page-work-grid-equal mt-4">
...
export const StoryboardView: React.FC = () => {
    ...
    const handlePlayNarration = useCallback(async (scene: Scene) => {
        ...
        try {
            ...
            if (!base64Audio || !outputAudioContext || !outputNode) return;
    ...
    return (
        <div className="page-shell-wide px-0 md:px-0 space-y-10 min-h-screen">
            ...
            <div className="space-y-6 pb-20 content-auto">
                {scenes.map((scene, idx) => (
                    <div key={scene.sceneNumber} className="content-auto-card">
                        <SceneCard
                            scene={scene}
                            index={idx}
