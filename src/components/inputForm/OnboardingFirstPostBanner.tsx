...
export const OnboardingFirstPostBanner: React.FC<OnboardingFirstPostBannerProps> = ({ onDismiss }) => (
  <div className="mb-6 p-4 rounded-lg bg-[var(--hero-accent-soft)] border border-[var(--hero-accent)]/30 flex items-start gap-3">
    <div className="p-2 rounded-lg shrink-0" style={{ backgroundColor: 'var(--hero-accent)' }}>
      <SparklesIcon className="w-5 h-5 text-white" />
    </div>
    <div className="flex-1 min-w-0">
      <p className="text-sm font-bold text-slate-900 dark:text-slate-100">Twój pierwszy post jest gotowy do wygenerowania</p>
