...
const TemplateBrowserModal = lazy(() => import('../TemplateBrowserModal').then((m) => ({ default: m.TemplateBrowserModal })));
const TopicAssistantModal = lazy(() => import('../TopicAssistantModal').then((m) => ({ default: m.TopicAssistantModal })));
const ReverseImageModal = lazy(() => import('../ReverseImageModal').then((m) => ({ default: m.ReverseImageModal })));
