        ...
        <div className="flex flex-col sm:flex-row items-start gap-4">
          ...
          <div className="shrink-0 flex gap-2 w-full sm:w-auto">
            <button
              ...
              className="flex-1 sm:flex-none px-4 py-2 text-xs font-medium text-slate-600 dark:text-slate-400 rounded-lg border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            >
              Odrzuć
            </button>
            <button
              onClick={handleAccept}
              className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1 px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-indigo-500 to-fuchsia-500 rounded-lg hover:opacity-90 transition-opacity"
            >
