    ...
    return (
        <div className="relative">
            ...
            <input 
                ...
                className="w-full min-h-[48px] bg-white dark:bg-[#0f1c2e] border border-slate-200 dark:border-white/10 rounded-lg py-3 pl-12 pr-12 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[var(--hero-accent)] focus:border-[var(--hero-accent)] transition-all touch-manipulation"
            />
            {isLoading && (
                 <div className="absolute right-4 top-1/2 -translate-y-1/2">
                    <svg className="animate-spin h-5 w-5 text-[var(--hero-accent)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
